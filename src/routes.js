...
const routes = [
  ...
  { path: '/salaries/profil/:id', exact: true, name: 'Profil',role:[{name:"RH"},{name:'ADMIN'},{name:'MANAGER'}], component: ProfilSalarie },
  { path: '/salaries/modification/:id', exact: true, name: 'Modification d\'un salarié',role:[{name:"RH"},{name:'ADMIN'}], component: UpdateSalarie },
  { path: '/salaries/updatePassword', exact: true, name: 'Modification du mot de passe',role:[{name:"RH"},{name:'ADMIN'}], component: UpdatePassword },
